// RUN: mlir-opt -load-pass-plugin=%mlir_lib_dir/KalininAlexandrFMAPass%shlibext --pass-pipeline="builtin.module(llvm.func(bonyuk_fused_multiply_add))" %s | FileCheck %s
